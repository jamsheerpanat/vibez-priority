...
<body class="min-h-screen flex flex-col items-center justify-center p-4">
    ...
    <div class="w-full max-w-md mt-20">
        <div class="success-card p-10 pt-1">
            ...
            <!-- Wallet Options -->
            <div class="space-y-4">
                <a href="{{ url('api/v1/wallet/apple/' . $userUuid) }}" target="_blank" class="btn-wallet">
                ...
                <a href="{{ url('api/v1/wallet/samsung/' . $userUuid) }}" target="_blank" class="btn-wallet">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        <path
